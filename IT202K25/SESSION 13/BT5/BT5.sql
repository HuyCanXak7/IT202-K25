...
BEGIN
    IF NEW.appointment_date < NOW() THEN
        ...
        SET MESSAGE_TEXT = 'Lỗi: không thể dời lịch khám về thời điểm trong quá khứ';
    END IF;
END //
DELIMITER ;

DROP TRIGGER IF EXISTS PreventStatusInsert;
DELIMITER //
...
BEGIN
    IF OLD.status = 'Completed' THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Lỗi: Không được phép thay đổi lịch khám đã hoàn thành';
    END IF;
END //
DELIMITER ;
...
VALUES (201, 1, '2026-05-20 09:00:00', 'Pending');

INSERT INTO Appointments(appointment_id, doctor_id, appointment_date, status)
VALUES (202, 1, '2026-05-20 09:00:00', 'Pending');

INSERT INTO Appointments(appointment_id, doctor_id, appointment_date, status)
VALUES (203, 1, '2026-05-20 09:00:00', 'Pending');

UPDATE Appointments
SET status = 'Completed'
WHERE appointment_id = 201;
...
BEGIN
    ...
    -- Gán giá dịch vụ vào actual_price
